...
const pages = [
  ...
  { to: "/requisitions/new", label: "Add Requisition", roles: ["Administrator", "Manager"] as Role[] },
  { to: "/panels/list", label: "Panel List", roles: ["Administrator", "Manager"] as Role[] },
  { to: "/panels", label: "Add Panel Member", roles: ["Administrator", "Manager"] as Role[] },
